...
!function (e, t) {
    ...
    var n = [], r = e.document, i = Object.getPrototypeOf, o = n.slice,
        a = n.concat, u = n.push, s = n.indexOf, l = {}, c = l.toString,
        f = l.hasOwnProperty, d = f.toString, p = d.call(Object), h = {},
        g = function e(t) {
    ...
    w.fn = w.prototype = {
        ...
        function () {
            var e, t, n, r, i, o, a = arguments[0] || {}, u = 1, s = arguments.length,
                l = !1;
            for ('boolean' == typeof a && (l = a, a = arguments[u] || {}, u++),
                'object' == typeof a || g(a) || (a = {}), u === s && (a = this, u--);
                u < s; u++)
        ...
        w.extend({
            ...
            makeArray: function (e, t) {
                var n = t || [];
                return null != e &&
                    (T(Object(e)) ? w.merge(n, 'string' == typeof e ? [e] : e) :
                        u.call(n, e)),
                    n
            },
    ...
    var E = function (e) {
        var t, n, r, i, o, a, u, s, l, c, f, d, p, h, g, v, y, m, b,
            x = 'sizzle' + 1 * new Date, w = e.document, C = 0, T = 0, E = ae(),
            N = ae(), k = ae(),
            A =
                function (e, t) {
                    return e === t && (f = !0), 0
                },
            D = {}.hasOwnProperty, S = [], L = S.pop, j = S.push, q = S.push,
            O = S.slice,
            P =
                function (e, t) {
            ...
            z = new RegExp('^' + I + '*([>+~]|' + I + ')' + I + '*'),
            _ = new RegExp('=' + I + '*([^\\]\'"]*?)' + I + '*\\]', 'g'),
            U = new RegExp(M), V = new RegExp('^' + R + '$'), X = {
                ID: new RegExp('^#(' + R + ')'),
                CLASS: new RegExp('^\\.(' + R + ')'),
                TAG: new RegExp('^(' + R + '|[*])'),
                ATTR: new RegExp('^' + B),
                ...
                needsContext: new RegExp(
                    '^' + I + '*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(' + I +
                    '*((?:-\\d)?\\d*)' + I + '*\\)|)(?=[^-]|$)',
                    'i')
            },
            Q = /^(?:input|select|textarea|button)$/i, Y = /^h\d$/i,
            G = /^[^{]+\{\s*\[native \w/, K = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
            J = /[+~]/,
        ...
        n = oe.support = {}, o = oe.isXML = function (e) {
            ...
            return a !== p && 9 === a.nodeType && a.documentElement ?
                (p = a, h = p.documentElement, g = !o(p),
                    w !== p && (i = p.defaultView) && i.top !== i &&
                    (i.addEventListener ?
            ...
            var t, r = [], i = 0, o = 0;
            if (f = !n.detectDuplicates, c = !n.sortStable && e.slice(0), e.sort(A),
                f) {
                ...
                CHILD: function (e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        var l, c, f, d, p, h,
                            ...
                            v = t.parentNode, y = u && t.nodeName.toLowerCase(),
                            m = !s && !u, b = !1;
                        if (v) {
                            if (o) {
                                while (g) {
        ...
        function ve() { }
        ve.prototype = r.filters = r.pseudos, r.setFilters = new ve,
            a = oe.tokenize = function (e, t) {
                ...
                while (u) {
                    n && !(i = F.exec(u)) ||
                        ...
                        n = !1,
                        (i = z.exec(u)) &&
                        (n = i.shift(), o.push({ value: n, type: i[0].replace($, ' ') }),
                            u = u.slice(n.length));
                    for (a in r.filter)
                        !(i = X[a].exec(u)) || l[a] && !(i = l[a](i)) ||
        ...
        function Ce(e, t, n, r, i, o) {
            return r && !r[x] && (r = Ce(r)), i && !i[x] && (i = Ce(i, o)),
                ue(function (o, a, u, s) {
            ...
            for (var t, n, i, o = e.length, a = r.relative[e[0].type],
                ...
                if (n = r.relative[e[s].type])
                    ...
                    if ((n = r.filter[e[s].type].apply(null, e[s].matches))[x]) {
                        ...
                        return Ce(
                            s > 1 && be(d),
                            s > 1 && ye(e.slice(0, s - 1).concat({
                                value: ' ' === e[s - 2].type ? '*' : ''
                            })).replace($, '$1'),
                            n, s < i && Te(e.slice(s, i)), i < o && Te(e = e.slice(i)),
                            i < o && ye(e))
                    }
                    d.push(n)
                }
        ...
        return u = oe.compile =
            ...
            function (e, t, n, i) {
                ...
                if (n = n || [], 1 === p.length) {
                    if ((s = p[0] = p[0].slice(0)).length > 2 &&
                        'ID' === (l = s[0]).type && 9 === t.nodeType && g &&
                        r.relative[s[1].type]) {
                        if (!(t =
                ...
                return (d || u(e, p))(
                    i, t, !g, n, !t || J.test(e) && ge(t.parentNode) || t),
                    n
            },
            n.sortStable = x.split('').sort(A).join('') === x,
            n.detectDuplicates = !!f, d(),
    ...
    w.fn.extend({
        ...
        index: function (e) {
            return e ?
                'string' == typeof e ? s.call(w(e), this[0]) :
    ...
    w.each(
        {
            ...
            contents: function (e) {
                return D(e, 'iframe') ? e.contentDocument :
    ...
    w.Callbacks = function (e) {
        ...
        var t, n, r, i, o = [], a = [], u = -1, s = function () {
            for (i = i || e.once, r = t = !0; a.length; u = -1) {
                n = a.shift();
                while (++u < o.length)
                    !1 === o[u].apply(n[0], n[1]) && e.stopOnFalse &&
                        (u = o.length, n = !1)
            }
                                ...
                                var u = this, s = arguments, l = function () {
                                    ...
                                    if (!(t < o)) {
                                        ...
                                        l = e &&
                                            ('object' == typeof e || 'function' == typeof e) &&
                                            e.then,
                                            g(l) ? i ? l.call(e, a(o, n, B, i), a(o, n, M, i)) :
                                                (o++ ,
                                                    l.call(
                                                        e, a(o, n, B, i), a(o, n, M, i),
    ...
    w.Deferred.exceptionHook = function (t, n) {
        e.console && e.console.warn && t && $.test(t.name) &&
    ...
    function z() {
        r.removeEventListener('DOMContentLoaded', z),
            e.removeEventListener('load', z), w.ready()
    }
    ...
    G.uid = 1, G.prototype = {
        ...
        remove: function (e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(Q) :
                        (t = Q(t)) in r ? [t] : t.match(I) || [])
                        .length;
    ...
    w.extend({
        ...
        w.extend({
            queue: function (e, t, n) {
                var r;
                if (e)
                    return t = (t || 'fx') + 'queue', r = K.get(e, t),
                        n &&
                        (!r || Array.isArray(n) ?
        ...
        w.fn.extend({
            ...
            promise: function (e, t) {
                ...
                while (a--)
                    (n = K.get(o[a], e + 'queueHooks')) && n.empty &&
                        (r++ , n.empty.add(u));
    ...
    function se(e, t, n, r) {
        ...
        if (c && c[3] !== l) {
            ...
            while (a--)
                w.style(e, t, c + l),
                    (1 - o) * (1 - (o = u() / s || .5)) <= 0 && (a = 0), c /= o;
            c *= 2, w.style(e, t, c + l), n = n || []
        }
        return n &&
            (c = +c || +s || 0, i = n[1] ? c + (n[1] + 1) * n[2] : +n[2],
    ...
    var xe = r.documentElement, we = /^key/,
    ...
    w.event = {
        ...
        add: function (e, t, n, r, i) {
            ...
            if (v) {
                n.handler && (n = (o = n).handler, i = o.selector),
                    i && w.find.matchesSelector(xe, i), n.guid || (n.guid = w.guid++),
                    ...
                    if (u = Te.exec(t[l]) || [], p = g = u[1],
                        ...
                        while (o--)
                            c = d[o],
                                ...
                                (d.splice(o, 1), c.selector && d.delegateCount-- ,
        ...
        handlers: function (e, t) {
            ...
            return l = this, s < t.length && u.push({ elem: l, handlers: t.slice(s) }),
                u
        },
    ...
    function Re(e, t, n, r) {
        ...
        if (d &&
            (i = be(t, e[0].ownerDocument, !1, e, r), o = i.firstChild,
            ...
            if (s)
                for (c = u[u.length - 1].ownerDocument, w.map(u, Pe), f = 0; f < s; f++)
                    l = u[f],
                        he.test(l.type || '') && !K.access(l, 'globalEval') &&
                        w.contains(c, l) &&
    ...
    function Fe(e, t, n) {
        ...
        return (n = n || We(e)) &&
            ('' !== (a = n.getPropertyValue(t) || n[t]) ||
                ...
                !h.pixelBoxStyles() && Me.test(a) && $e.test(t) &&
            ...
            'margin' === n && (s += w.css(e, n + oe[a], !0, i)),
                r ?
                    ...
                    (s += w.css(e, 'padding' + oe[a], !0, i),
                        'padding' !== n ? s += w.css(e, 'border' + oe[a] + 'Width', !0, i) :
                            u += w.css(e, 'border' + oe[a] + 'Width', !0, i));
        return !r && o >= 0 &&
            (s += Math.max(
                0,
                Math.ceil(
                    e['offset' + t[0].toUpperCase() + t.slice(1)] - o - s -
                    u - .5))),
            s
    }
    function et(e, t, n) {
        var r = We(e), i = Fe(e, t, r),
    ...
    w.extend({
        ...
        css: function (e, t, n, r) {
            ...
            return Ue.test(t) || (t = Ke(u)),
                (a = w.cssHooks[t] || w.cssHooks[u]) && 'get' in a &&
                (i = a.get(e, !0, n)),
                void 0 === i && (i = Fe(e, t, r)),
                    ...
                    set: function (e, n, r) {
                        ...
                        return a && h.scrollboxSize() === o.position &&
                            (u -= Math.ceil(
                                ...
                                .5)),
                            u && (i = ie.exec(n)) && 'px' !== (i[3] || 'px') &&
                            (e.style[t] = n, n = w.css(e, t)),
                            Je(e, n, u)
                    }
                }
            }),
        w.cssHooks.marginLeft =
        ze(h.reliableMarginLeft,
            function (e, t) {
                if (t)
        ...
        w.fn.delay = function (t, n) {
            ...
            var e = r.createElement('input'),
                t = r.createElement('select').appendChild(
                    r.createElement('option'));
            e.type = 'checkbox', h.checkOn = '' !== e.value,
    ...
    w.fn.extend({
        ...
        w.each(w.expr.match.bool.source.match(/\w+/g), function (e, t) {
            ...
            nt[t] = function (e, t, r) {
                ...
                return r ||
                    (o = nt[a], nt[a] = i, i = null != n(e, t, r) ? a : null,
                        nt[a] = o),
                    i
            }
        });
            ...
            var t, n, r, i = this[0];
            {
                ...
                if (i)
                    return (t = w.valHooks[i.type] ||
                        ...
                        n :
                        'string' == typeof (n = i.value) ? n.replace(st, '') :
                            null == n ? '' : n
            }
        }
    }),
    ...
    w.extend(w.event, {
        trigger: function (t, n, i, o) {
            var a, u, s, l, c, d, p, h,
                y = [i || r], m = f.call(t, 'type') ? t.type : t,
            ...
            if (u = h = s = i = i || r,
                ...
                (m.indexOf('.') > -1 &&
                    ...
                    t.isTrigger = o ? 2 : 3, t.namespace = b.join('.'),
                ...
                if (!o && !p.noBubble && !v(i)) {
                    for (l = p.delegateType || m, lt.test(l + m) || (u = u.parentNode); u;
                        u = u.parentNode)
                        y.push(u), s = u;
                    s === (i.ownerDocument || r) &&
                ...
                return t.type = m,
                    ...
                    p._default && !1 !== p._default.apply(y.pop(), n) || !Y(i) ||
                    c && g(i[m]) && !v(i) &&
                    ((s = i[c]) && (i[c] = null), w.event.triggered = m,
                        t.isPropagationStopped() && h.addEventListener(m, ct),
                        i[m](),
                        t.isPropagationStopped() &&
                        h.removeEventListener(m, ct),
                        w.event.triggered = void 0, s && (i[c] = s)),
                    t.result
            }
        },
    ...
    function gt(e, t, n, r) {
        ...
        if (Array.isArray(t))
            w.each(t, function (t, i) {
                n || ft.test(e) ?
                    r(e, i) :
                    gt(e + '[' + ('object' == typeof i && null != i ? t : '') + ']', i,
                        n, r)
            });
    ...
    w.param =
                ...
                return this
                    ...
                    .filter(function () {
                        ...
                        return this.name && !w(this).is(':disabled') &&
                            ht.test(this.nodeName) && !pt.test(e) &&
        ...
        function (e, t, n) {
            ...
            return t ||
                ...
                o ? [t.createElement(o[1])] :
                    (o = be([e], t, a), a && a.length && w(a).remove(),
        ...
        w.offset = {
            setOffset: function (e, t, n) {
                ...
                'static' === c && (e.style.position = 'relative'),
                    u = f.offset(), o = w.css(e, 'top'), s = w.css(e, 'left'),
        ...
        w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = D,
        w.isFunction = g, w.isWindow = v, w.camelCase = Q, w.type = b,
        w.now = Date.now,
        w.isNumeric =
        function (e) {
            var t = w.type(e);
